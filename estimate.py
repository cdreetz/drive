...
# Directory containing the unlabeled videos
unlabeled_dir_path = 'unlabeled/'

# Loop over all the '.hevc' files in the directory
for filename in os.listdir(unlabeled_dir_path):
    if filename.endswith('.hevc'):
        # Full path of the video file
        video_path = os.path.join(unlabeled_dir_path, filename)
